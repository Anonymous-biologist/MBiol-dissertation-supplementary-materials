...
```{r}
# GFP filterset data
GFP = read_csv("D:/Oxford/4th-year Project/Results/Images/Fluorescence/Results - GFP.csv")

# mCherry filterset data
mCherry = read_csv("D:/Oxford/4th-year Project/Results/Images/Fluorescence/Results - mCherry.csv")
```
...
```{r}
# Load lifespan data
lifespan = read_csv("D:/Oxford/4th-year Project/Results/Lifespan data - R.csv")
